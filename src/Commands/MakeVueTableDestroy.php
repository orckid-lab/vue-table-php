 ...
 */
class MakeVueTableDestroy extends GeneratorCommand
{
	/**
	 ...
	 * @var string
	 */
	protected $signature = 'vue-table:destroy {name}';
	...
	{
		return $this->rootNamespace() . 'VueTables\Destroys';
	}
	...
	{
		return __DIR__ . '/stubs/destroy.stub';
	}
	...
	{
		return $this->argument('name') . 'Destroy';
	}
}
